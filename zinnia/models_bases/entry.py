...
class AuthorsEntry(models.Model):
    ...
    """
    # authors = models.ManyToManyField('blog.BlogAuthor', blank=True,related_name='entries',verbose_name=_('authors'))
    authors = models.ForeignKey("blog.BlogAuthor", related_name="entries", null=True, blank=True,verbose_name=_('author'))
...
class CategoriesEntry(models.Model):
    ...
    categories = models.ForeignKey("zinnia.Category", related_name="entries", null=True, blank=True,verbose_name=_('category'))
